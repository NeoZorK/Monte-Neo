"""Binance venue adapter: paper default; live env-gated + dry-run."""
...
class BinanceAdapter:
    """Binance-facing adapter. Default mode is local paper (no network)."""
    ...
    def __init__(
        ...
        *,
        ...
        self._api_key = api_key if api_key is not None else os.getenv("BINANCE_API_KEY", "")
        self._api_secret = (
