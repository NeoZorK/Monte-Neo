...
def check_system():
    console.print(Panel.fit("Native System Check: Genetic Algorithms & Dynamic Indicators", style="bold blue"))
    ...
    if result.final_metrics:
        metrics_table = Table(title="Final Metrics", show_header=True, header_style="bold magenta")
