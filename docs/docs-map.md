...
- docs/project/ROADMAP.md - Development roadmap and milestones (v0.22.0)
- docs/project/PRODUCT_STRATEGY_RU.md - Product strategy: agent-native strategy verifier niche, moat, roadmap (RU, internal)
- docs/project/CHANGELOG.md - Release changelog (current: v0.22.0)
...
- src/monte_neo/_version.py - Central version management (v0.22.0)
