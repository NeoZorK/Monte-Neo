...
- docs/project/ROADMAP.md - Development roadmap and milestones (v0.30.0)
...
- docs/project/CHANGELOG.md - Release changelog (current: v0.30.0)
...
- docs/guides/trap-suite.md - Trap Suite catalogue (40 traps, 15 honest controls) and how to contribute a trap
...
- src/monte_neo/_version.py - Central version management (v0.30.0)
