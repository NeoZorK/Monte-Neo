...
Статус: **только список, ничего не удалено.** Каждый пункт удаляется только после явного
одобрения владельца (NeoZorK). Данные собраны на ветке после v0.22.0.
