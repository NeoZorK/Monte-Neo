...
- docs/project/ROADMAP.md - Development roadmap and milestones (v0.15.1)
- docs/project/CHANGELOG.md - Release changelog (current: v0.15.1)
...
- src/monte_neo/_version.py - Central version management (v0.15.1)
