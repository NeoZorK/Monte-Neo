...
- docs/project/ROADMAP.md - Development roadmap and milestones (v0.17.4)
- docs/project/CHANGELOG.md - Release changelog (current: v0.17.4)
...
- src/monte_neo/_version.py - Central version management (v0.17.4)
