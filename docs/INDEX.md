...
- docs/project/ROADMAP.md - Development roadmap and milestones (v0.12.0)
- docs/project/CHANGELOG.md - Release changelog (current: v0.12.0)
...
- src/monte_neo/_version.py - Central version management (v0.12.0)
